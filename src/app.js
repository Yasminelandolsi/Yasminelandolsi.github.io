...
import * as Ammo from "./builds/ammo.js";
...
Ammo().then((Ammo) => {
  ...
  function createBeachBall() {
    ...
    beachTexture.encoding = sRGBEncoding;
  ...
  function createBox(
    ...
    const linkBox = new THREE.Mesh(
      new BoxBufferGeometry(boxScale.x, boxScale.y, boxScale.z),
      materials
    );
  ...
  function loadFloydText() {
    ...
    text_loader.load("./src/jsm/Roboto_Regular.json", function (font) {
      ...
      var geometry = new TextGeometry("0xFloyd", {
        font: font,
        size: 3,
        height: 0.5,
        curveSegments: 12,
  ...
  function createWallX(x, y, z) {
    ...
    const wall = new THREE.Mesh(
      new BoxBufferGeometry(wallScale.x, wallScale.y, wallScale.z),
      new THREE.MeshStandardMaterial({
        color: 0xffffff,
        opacity: 0.75,
        transparent: true,
  ...
  function createTriangle(x, z) {
    ...
    geom.faces.push(new THREE.Triangle(0, 1, 2));
